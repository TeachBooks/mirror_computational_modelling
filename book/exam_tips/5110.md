...
## Nonlinear FEM 
  ...
  1. {doc}`../solid_nonlinear/introduction`: There might be conceptual questions about incremental FE simulations in the exam. The concept of tangent stiffness matrices and the need for path following algorithms is also important. Geometric nonlinearities will not be part of the exam.
